    ...
    <form @click="onclick" report-submit='true' @submit="formSubmit">
        <button formType="submit" class="form-button" hover-class="none">
            <div class="member-center">
                ...
                <img v-if="!user.member" class="member-bgimg" style="height: 163rpx;" src="https://img-ali.xiaohongchun.com.cn/admin/15620687031811c7f6860.png"/>
...
<style src="../member/style.css" scoped></style>
